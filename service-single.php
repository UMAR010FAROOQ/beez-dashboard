		...
		<div class="container">
			<div class="ft-breadcrumb-content headline text-center position-relative">
				...
				<div class="ft-breadcrumb-list ul-li">
					<ul>
						<li><a href="#">Home</a></li>
						<li>Services</li><li>Supply Chain Management</li>
					</ul>
				</div>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-lg-4">
						<div class="ft-service-sidebar">
							<div class="ft-service-sidebar-widget headline ul-li-block wow fadeInLeft" data-wow-delay="400ms" data-wow-duration="300ms">
								<div class="service-category-widget">
									<h3 class="widget-title">All Service</h3>
									<ul>
										<li><a href="service-single.php">Warehousing</a></li>
											<li><a href="service-single.php">Our Fleet</a></li>
											<li><a href="service-single.php">Supply Chain Management</a></li>
											<li><a href="service-single.php">Advanced I.T Integrations</a></li>
											<li><a href="service-single.php">Customer service</a></li>
									</ul>
								</div>
							</div>
							...
							<div class="ft-service-sidebar-widget headline ul-li-block">
								<div class="service-download-widget">
									...
									<ul>
										<li><a href="#">Download Profile <i class="far fa-file-pdf"></i></a></li>
									</ul>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-8">
						<div class="ft-service-details-content-wrapper headline pera-content">
							<div class="ft-service-details-img-wrapper">
								<div class="row">
									<div class="col-md-6 wow fadeInReft" data-wow-delay="400ms" data-wow-duration="300ms" >
										<div class="ft-service-details-img">
											<img src="assets/img/service/sd1.jpg" alt="">
										</div>
									</div>
									<div class="col-md-6 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="300ms">
										<div class="ft-service-details-img">
											<img src="assets/img/service/sd2.jpg" alt="">
										</div>
										<div class="ft-service-details-img wow fadeInRight" data-wow-delay="100ms" data-wow-duration="800ms">
